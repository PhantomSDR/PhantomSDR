...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__ZN6redsea13initMPXReaderEiPPc')) {
        Object.defineProperty(Module['ready'], '__ZN6redsea13initMPXReaderEiPPc', { configurable: true, get: function() { abort('You are getting __ZN6redsea13initMPXReaderEiPPc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__ZN6redsea13initMPXReaderEiPPc', { configurable: true, set: function() { abort('You are setting __ZN6redsea13initMPXReaderEiPPc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__ZN6redsea7readMPXEPfi')) {
        Object.defineProperty(Module['ready'], '__ZN6redsea7readMPXEPfi', { configurable: true, get: function() { abort('You are getting __ZN6redsea7readMPXEPfi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__ZN6redsea7readMPXEPfi', { configurable: true, set: function() { abort('You are setting __ZN6redsea7readMPXEPfi on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__ZN6redsea8closeMPXEv')) {
        Object.defineProperty(Module['ready'], '__ZN6redsea8closeMPXEv', { configurable: true, get: function() { abort('You are getting __ZN6redsea8closeMPXEv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__ZN6redsea8closeMPXEv', { configurable: true, set: function() { abort('You are setting __ZN6redsea8closeMPXEv on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'redsea.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('redsea.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var __ZN6redsea13initMPXReaderEiPPc = Module["__ZN6redsea13initMPXReaderEiPPc"] = createExportWrapper("_ZN6redsea13initMPXReaderEiPPc");

/** @type {function(...*):?} */
var __ZN6redsea7readMPXEPfi = Module["__ZN6redsea7readMPXEPfi"] = createExportWrapper("_ZN6redsea7readMPXEPfi");

/** @type {function(...*):?} */
var __ZN6redsea8closeMPXEv = Module["__ZN6redsea8closeMPXEv"] = createExportWrapper("_ZN6redsea8closeMPXEv");
